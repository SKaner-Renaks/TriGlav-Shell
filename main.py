    ...
    <script>
        ...
        function selectModule(name) {
            ...
            if (mod.running && mod.port) {
                ...
                document.getElementById('module-name').innerHTML = '<img src="/_images/developer_board.svg" style="width:16px;height:16px;vertical-align:middle;margin-right:6px;">Информация';
